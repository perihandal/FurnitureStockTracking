...
namespace App.Repositories.Migrations
{
    ...
    [Migration("20250917133519_newbranches")]
    partial class newbranches
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Repositories.TransferRequests.TransferRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("App.Repositories.TransferRequests.TransferRequest", b =>
                {
                    b.HasOne("App.Repositories.Users.User", "ApprovedByUser")
                        .WithMany()
                    ...
                    b.HasOne("App.Repositories.Users.User", "RequestedByUser")
                        .WithMany()
